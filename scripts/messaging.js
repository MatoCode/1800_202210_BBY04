...
//       //save all message with random id, sort with timestamp 
//       currGroup = "tFnveRf4TMwUGdW8T8KP";
//       //Store username
//       db.collection("groups").doc(currGroup).collection("messagingText").add({          
//           message: document.getElementById('textbox').value,
//           username: user.displayName,
//           timestamp: Date.now()
//       }).then(function() {
...
//     // var messageRef = db.collection("groups").doc(currGroup).collection("messagingText");
